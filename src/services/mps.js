...
JDCloud.MPS = class MPS extends Service {
  ...
  /**
         ...
         * @param {integer} [opts.limit] - 查询记录数  optional
  ...
  listThumbnailTask (opts, regionId = this.config.regionId, callback) {
    ...
    let headerParams = {
      'User-Agent': 'JdcloudSdkNode/1.0.0  mps/0.3.2'
    }
  ...
  /**
         ...
         * @param {integer} [opts.errorCode] - 错误码  optional
         * @param {string} [opts.createdTime] - 任务创建时间  optional
         * @param {string} [opts.lastUpdatedTime] - 任务创建时间  optional
         * @param {thumbnailTaskSource} [opts.source]   optional
         * @param {thumbnailTaskTarget} [opts.target]   optional
  ...
  /**
         ...
         * @param {string} [opts.endpoint] - 通知endpoint，当前支持http://和https://, 未来会支持sms:, email:, queues: 等  optional
         * @param {array} [opts.events] - 触发通知的事件集合  optional
         ...
         * @param {string} [opts.notifyContentFormat] - 描述了向 Endpoint 推送的消息格式, JSON包含消息正文和消息属性, SIMPLIFIED消息体即用户发布的消息，不包含任何属性信息  optional
         * @param {string} regionId - ID of the region
         * @param {string} callback - callback
         @return {Object} result
      */
