...
imageId - 镜像ID，模糊匹配，支持单个
  ...
  /**
         *  创建一台或多台指定配置的实例
         * @param {Object} opts - parameters
         * @param {instanceSpec} [opts.instanceSpec] - 创建主机规格  optional
...
&quot;主机没有未完成的任务才可制作镜像&quot;
  ...
  /**
         ...
         * @param {string} opts.deviceName - 逻辑挂载点[vdb,vdc,vdd,vde,vdf,vdg,vdh]
         * @param {boolean} [opts.autoDelete] - 当删除主机时，是否自动关联删除此硬盘，默认False，此对按配置计费生效  optional
         * @param {string} regionId - ID of the region
         * @param {string} callback - callback
         @return {Object} result
      */
  ...
  attachDisk (opts, regionId = this.config.regionId, callback) {
    ...
    if (opts.deviceName === undefined || opts.deviceName === null) {
      throw new Error(
        "Missing the required parameter 'opts.deviceName' when calling attachDisk"
      )
    }
...
&quot;g)至少同时包含三类（大写字母，小写字母，数字和特殊字符，特殊字符为 ** ()&#x60;~!@#$%&amp;_-+&#x3D;{}[]:\&quot;;&#39;&lt;&gt;,.?/）*|&quot;
  ...
  /**
         ...
         * @param {string} opts.name - 启动模板的名称
         * @param {string} [opts.description] - 启动模板的描述  optional
         * @param {string} regionId - ID of the region
         * @param {string} callback - callback
         @return {Object} result
  ...
  /**
         *  查询启动模板详情
         * @param {Object} opts - parameters
         * @param {string} opts.instanceTemplateId - instanceTemplate ID
         * @param {string} regionId - ID of the region
         * @param {string} callback - callback
         @return {Object} result
  ...
  describeQuotas (opts, regionId = this.config.regionId, callback) {
    ...
    let request = this.makeRequest(
      '/regions/{regionId}/regions/{regionId}/quotas',
      'GET',
      pathParams,
      queryParams,
      headerParams,
